...
Public Class DatabaseHelper
    ...
    Public Sub ExecuteNonQuery(query As String, Optional parameters As List(Of SqlParameter) = Nothing, Optional isStoredProcedure As Boolean = False)
        ...
        End Using
    End Sub
    ' Método para ejecutar una consulta SQL que devuelve un solo valor
    Public Function ExecuteScalar(sql As String, parametros As List(Of SqlParameter)) As Object
